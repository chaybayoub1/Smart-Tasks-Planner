...
Route::post('/groups/{group}/invitations', [CollaborationInvitationController::class, 'store'])
    ->name('groups.invitations.store');

Route::get('/group-invitations/{token}/accept', [CollaborationInvitationController::class, 'accept'])
    ->name('groups.invitations.respond');

Route::post('/group-invitations/{token}/decline', [CollaborationInvitationController::class, 'decline'])
    ->name('groups.invitations.decline');

Route::post('/groups/{group}/tasks', [GroupTaskController::class, 'store'])
    ->name('groups.tasks.store');

Route::patch('/groups/{group}/tasks/{task}/status', [GroupTaskController::class, 'updateStatus'])
    ->name('groups.tasks.status');

Route::delete('/groups/{group}/tasks/{task}', [GroupTaskController::class, 'destroy'])
    ->name('groups.tasks.destroy');
    });