                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-3">
                                <div class="avatar-preview-wrapper">
                                    ...
                                    @else
                                        <div id="avatarPlaceholder" class="hero-avatar-placeholder">{{ $user->initials() }}
                                        </div>
                                ...
                                <div>
                                    ...
                                    @if($user->avatar)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="removeAvatar"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control"
                                        value="{{ old('username', $user->username) }}" placeholder="janedoe99">
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="bio" class="form-control" rows="3" maxlength="300"
                                placeholder="Tell others about you…">{{ old('bio', $user->bio) }}</textarea>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="university" class="form-control"
                                            value="{{ old('university', $user->university) }}" placeholder="MIT, Stanford…">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                @foreach($methods as $m)
                                    ...
                                    <input type="checkbox" class="btn-check" id="method_{{ $m['value'] }}" autocomplete="off"
                                        name="study_methods[]" value="{{ $m['value'] }}" {{ $checked ? 'checked' : '' }}>
                                    <label class="btn btn-outline-primary btn-study-method {{ $checked ? 'active' : '' }}"
                                        for="method_{{ $m['value'] }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <input type="range" name="study_goal" min="0.5" max="12" step="0.5" class="form-range"
                                    value="{{ old('study_goal', $user->study_goal ?? 2) }}"
                                    oninput="document.getElementById('goalVal').textContent = this.value + 'h'">
                                <div class="badge bg-secondary" id="goalVal">
                                    {{ old('study_goal', $user->study_goal ?? 2) }}h</div>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach([['dark', 'bi-moon-stars-fill', 'Dark'], ['light', 'bi-sun-fill', 'Light'], ['system', 'bi-circle-half', 'System']] as $option)
                                        @php [$val, $ico, $lbl] = $option;
                                        $selected = old('theme', $user->theme ?? 'dark') == $val; @endphp
                                        <input type="radio" class="btn-check" name="theme" id="theme_{{ $val }}"
                                            value="{{ $val }}" autocomplete="off" {{ $selected ? 'checked' : '' }}>
                                        <label
                                            class="btn btn-outline-secondary btn-theme-option {{ $selected ? 'active' : '' }}"
                                            for="theme_{{ $val }}">
        ...
        <div class="col-12 col-xl-4">
            ...
            <div class="card shadow-sm danger-card">
                <div class="card-body">
                    ...
                    <p class="text-muted">Once deleted, all your data — tasks, notes, flashcards, sessions — will be
                        permanently removed.</p>
                    <button class="btn btn-outline-danger w-100 mb-3" type="button" data-bs-toggle="collapse"
                    ...
                    <div class="collapse" id="deleteForm">
                        <form method="POST" action="{{ route('profile.destroy') }}">
                            ...
                            <div class="mb-3">
                                ...
                                @error('password', 'userDeletion') <div class="form-text text-danger">{{ $message }}</div>
                                @enderror
                            </div>
